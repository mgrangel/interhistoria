                            ...
                            <div class="row">
                                <form role="form" id="frm_columna_dorsal" class="form_historia">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!-- Ex FCC -->
                                        <div class="form-group">
                                            <a href="#!" class="lsec sw" name="x_ef_colcerv">Examen de Columna Cervical 
                                            <i class="fa fa-chevron-down"></i></a>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <div class="checkbox">
                                                    <label for="mid_medreal">Miembro inferior izquierdo</label>
                                                    <div id="ef_medamii" class="sldbarval" style="width:85%; float:left;"></div>
                                                    <div id="ef_medamii_val" class="labsldbarval"></div>
                                                    <div style="clear:both;"></div>
                                                    <input type="hidden" class="form-control finput" name="ef_medamii" id="frm_ef_medamii">
                                                </div>
                                                <div class="checkbox">
                                                  <label for="mid_medreal">Miembro inferior derecho</label>
                                                  <div id="ef_medamid" class="sldbarval" style="width:85%; float:left;"></div>
                                                  <div id="ef_medamid_val" class="labsldbarval"></div>
                                                  <div style="clear:both;"></div>
                                                  <input type="hidden" class="form-control finput" name="ef_medamid" id="frm_ef_medamid">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="checkbox">
                                            <input type="text" class="form-control finput" name="ef_notas2" title="300">
                                        </div>
                                        <!-- * -->
                                        <div class="form-group">
                                            <div>

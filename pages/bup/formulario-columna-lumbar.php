                            ...
                            <div class="row">
                                <form role="form" id="frm_columna_lumbar" class="form_historia">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group subform">
                                                ...
                                                <div class="checkbox">
                                                    <input type="text" class="form-control finput" name="ins_notas1">
                                                </div>
                                            </div>
                                            <div class="form-group subform">
                                        ...
                                        <!-- * -->
                                        <label for="maniobras">
                                            <a href="#!" data-toggle="modal" data-target="#manmodal" class="lsec">
                                        ...
                                        <div class="form-group">
                                            <div>
                                            	<label for="exam_miembro_inf_izq" class="tsec">Examen de Miembro Inferior Izquierdo</label>
                                            </div>
                                            <div class="form-group">
                                                <div class="checkbox">
                                            ...
                                            <div class="form-group subform"><label for="fuerza_muscular_mii">Fuerza muscular</label></div>
                                            <div class="form-group subform">
                                                <div class="checkbox">
                                                ...
                                                <div class="checkbox">
                                                    <input type="text" class="form-control finput" name="rfi_eminotas">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <div>
                                              <label for="exam_miembro_inf_izq" class="tsec">Examen de Miembro Inferior Derecho</label></div>
                                            <div class="checkbox">
                                            ...
                                            <div class="form-group subform"><label for="fuerza_muscular_mid">Fuerza muscular</label></div>
                                            <div class="form-group subform">
                                                <div class="checkbox">
                                                  	<div>
                                                ...
                                                <div class="checkbox">
                                                    <input type="text" class="form-control finput" name="rfd_eminotas">
                                                </div>
                                            </div>
                                        </div>   
                                        <!-- * -->
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <a href="#!" class="lsec sw" name="x_ef_excadera">Examen de caderas <i class="fa fa-chevron-down">
                                                </i></a>
                                            </div>
                                            ...
                                            <div class="checkbox">
                                                <a href="#!" class="lsec sw" name="x_ef_excoltor">Examen columna torácica <i class="fa fa-chevron-down"></i></a>
                                            </div>
                                            ...
                                            <div class="checkbox">
                                              <input type="text" class="form-control finput" name="ef_notas">
                                            </div>
                                        </div>
                                        <!-- * -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group subform">
                                            	...
                                            	<!-- infiltración -->
                                            	<div class="form-group">
                                                    <div><label for="Palpación">Infiltración</label></div>
                                                    <div class="checkbox">
                                                        <label class="checkbox-inline">
                                                    ...
                                                    <div class="checkbox">
                                                        <input type="text" class="form-control finput" name="pro_notas">
                                                    </div>
                                            	</div>
                                            	<!-- cirugía -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox">
                                                        <input type="text" class="form-control finput" name="cir_notas">
                                                    </div>
                                                </div>
                                            	<!-- -->
                                            </div>

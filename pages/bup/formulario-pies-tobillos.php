                            ...
                            <div id="panel-bizq" class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" id="frm_pie_tobillo" class="form_historia">
                                        ...
                                        <!--<label for="Antecedentes y Examen funcional">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="checkbox">
                                                  <input type="text" class="form-control finput" name="pal_notas" title="300">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- -->
                                        <div class="checkbox">
                                            <a href="#!" class="lsec sw" name="x_ef_excolumb">
                                        ...
                                        <!-- -->
                                        <div class="checkbox">
                                            <a href="#!" class="lsec sw" name="x_ef_ex_caipsi">
                                        ...
                                        <!-- -->
                                        <div class="checkbox">
                                            <a href="#!" class="lsec sw" name="x_ef_ex_roipsi">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" id="frm_pie_tobillo_d" class="form_historia">
                                        ...
                                        <!-- Bloque Antecedentes personales y Examen Funcional -->
                                        <!--<label for="Antecedentes y Examen funcional">
                                            <a href="#!" data-toggle="modal" data-target="#antemodal_D" class="lsec">Antecedentes y Examen funcional
                                            <i class="fa fa-list-alt"></i></a>
                                        </label>-->
                                        <?php //include( "subforms/antecedentes_d.php" )?>
                                        <!-- FIN Bloque Antecedentes personales y Examen Funcional -->
                                        <div class="form-group">
                                            <label for="examen_físico" class="tsec">Examen físico</label>
                                            <!-- * -->
                                        ...
                                        <!-- -->
                                        <div class="checkbox">
                                            <a href="#!" class="lsec sw" name="x_ef_excolumb_d">
                                            	Columna común <i class="fa fa-chevron-down"></i>
                                            </a>
                                        </div>
                                        ...
                                        <!-- -->
                                        <div class="checkbox">
                                            <a href="#!" class="lsec sw" name="x_ef_ex_caipsi_d">
                                            	Examen de cadera ipsilateral <i class="fa fa-chevron-down"></i>
                                            </a>
                                        </div>
                                        ...
                                        <!-- -->
                                        <div class="checkbox">
                                            <a href="#!" class="lsec sw" name="x_ef_ex_roipsi_d">
                                            	Examen de rodilla ipsilateral <i class="fa fa-chevron-down"></i>
                                            </a>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="procedimientos" class="tsec">Procedimientos</label>
                                            <div class="checkbox">
                                                <label for="pr_atrocentesis">Artrocentésis</label>
                                                <input type="text" class="form-control finput" name="pr_atrocentesis">
                                            </div>
                                            <div class="form-group subform">
                                                <label for="Examen de cadera">Infiltración</label>

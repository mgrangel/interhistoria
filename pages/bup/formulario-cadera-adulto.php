                                ...
                                <form role="form" id="frm_cadera_adulto" class="form_historia">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                        	...
                                        	<div class="form-group">
                                            	<label for="medicion_real">Medición real</label>
                                                <div class="checkbox">
                                                ...
                                                <label for="medicion_aparente">Medición aparente</label>
                                                <div class="checkbox">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                        	<div class="checkbox">
                                                <a href="#!" class="lsec sw" name="x_exfco">
                                            ...
                                            <div class="checkbox">
                                                <a href="#!" class="lsec sw" name="x_exfro">Examen de Rodilla <i class="fa fa-chevron-down"></i></a>
                                            </div>
                                            ...
                                            <div><a href="#!">Score de Harris</a></div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                              <label class="checkbox-inline">
                                              <input type="checkbox" name="pro_infilt">Infiltración</label>
                                            </div>
                                            <div class="checkbox">
                                              <label class="checkbox-inline">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                              <label class="checkbox-inline">
                                              <input type="checkbox" name="cir_atrop">Artrosplastia total</label>
                                            </div>
                                            <div class="checkbox">

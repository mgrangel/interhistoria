                                ...
                                <form role="form" id="frm_rodilla" class="form_historia">
                                    ...
                                    <div class="col-lg-6" id="primera_columna">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- Palpación -->
                                            <div class="form-group subform">
                                                <label for="palpacion" class="tseclnk">Palpación</label>
                                                <div class="checkbox">
                                                    <label class="checkbox-inline">
                                                ...
                                                <div class="checkbox">
                                                    <input type="text" class="form-control finput" name="pal_crepnota" title="300" placeholder="Notas">
                                                </div>
                                                <!-- ------------------------------------------------------------------------------------- -->
                                                <div class="checkbox">
                                    ...
                                    <div class="col-lg-6" id="segunda_columna">
                                        ...
                                        <div class="form-group examen_fisico">
                                            ...
                                            <!-- Ex FCA -->
                                            <div class="checkbox">
                                                <a href="#!" class="lseclnk_drop sw" name="x_ef_cadera">Examen de caderas <i class="fa fa-chevron-down">
                                                </i></a>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                              <label class="checkbox-inline">
                                              <input type="checkbox" id="chrx" name="x_pl_rx" value="RM">Rayos X</label>
                                            </div> 
                                        	...
                                        	<div class="form-group subform">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox">
                                                    	<label class="checkbox-inline">
                                                    	<input type="checkbox" name="pro_atrocentesis">Artrocentesis</label>
                                                    </div>
                                                	<!-- Infiltración -->
                                                    <div class="checkbox">
                                                    	<label class="checkbox-inline">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox">
                                                        <label class="checkbox-inline">
                                                        <input type="checkbox" name="x_cir_otros" class="sw">Otros</label>
                                                        <input type="text" id="x_cir_otros" class="form-control finput fw" name="cir_otros">
                                                    </div>
                                                </div><!-- /.Cirugía -->
